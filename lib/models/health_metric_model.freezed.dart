...
/// @nodoc
@JsonSerializable()
class _$HealthMetricImpl with DiagnosticableTreeMixin implements _HealthMetric {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'HealthMetric(id: $id, type: $type, value: $value, unit: $unit, notes: $notes, timestamp: $timestamp, date: $date, userId: $userId)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'HealthMetric'))
  ...
  int get hashCode => Object.hash(
      runtimeType, id, type, value, unit, notes, timestamp, date, userId);
...
abstract class _HealthMetric implements HealthMetric {
  const factory _HealthMetric(
      ...
      final String? userId}) = _$HealthMetricImpl;
